            ...
            _dbConnection
                .Query<StoredProcedureSchema, StoredProcedureSchema.ParameterSchema, StoredProcedureSchema>($@"
                    ...
                    select 
                        ...
                        p.is_result as {nameof(StoredProcedureSchema.ParameterSchema.IsOutput)},
                        p.data_type as {nameof(StoredProcedureSchema.ParameterSchema.Type)},
                        p.character_maximum_length as {nameof(StoredProcedureSchema.ParameterSchema.MaxLength)},
                        p.parameter_default as {nameof(StoredProcedureSchema.ParameterSchema.DefaultValue)},
