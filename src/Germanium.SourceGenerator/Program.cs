...
using Germanium;
using Germanium.SourceGenerator;
using Germanium.SourceGenerator.Generators;
...
foreach (var provider in providers)
{
    ...
    foreach (var item in iniData.Sections["FUNCTIONS"])
    {
        ...
        var generatedCode = new Germanium.SourceGenerator.Generators.FunctionGenerator().Generate(code);
    ...
    {
        var generatedCode = new Germanium.SourceGenerator.Generators.FunctionExtensionGenerator().Generate(genCode);
    ...
    foreach (var item in iniData.Sections["CLASSES"])
    {
        ...
        var generatedCode = new Germanium.SourceGenerator.Generators.StatementGenerator().Generate(code);
    ...
    {
        var generatedCode = new Germanium.SourceGenerator.Generators.StatementExtensionGenerator().Generate(genCode);
