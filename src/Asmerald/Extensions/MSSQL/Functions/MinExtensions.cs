...
namespace Asmerald.MSSQL
{
    ...
    {
        public static MinAggregateFunction Min(this MSSQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MinAggregateFunction(x);
        }
        public static MinFunction Min(this MSSQLDSLContext stmt, ISelectExpression x)
        {
