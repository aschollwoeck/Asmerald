...
namespace Asmerald.MSSQL
{
    ...
    {
        public static MaxAggregateFunction Max(this MSSQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MaxAggregateFunction(x);
        }
        public static MaxFunction Max(this MSSQLDSLContext stmt, ISelectExpression x)
        {
