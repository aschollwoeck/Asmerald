...
namespace Asmerald.MSSQL
{
    ...
    {
        public static SubstrLengthFunction Substr(this MSSQLDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstrFunction Substr(this MSSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
