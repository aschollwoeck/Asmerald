...
namespace Asmerald.MSSQL
{
    ...
    {
        public static RoundFunction Round(this MSSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RoundDigitsFunction Round(this MSSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
