...
namespace Asmerald.MSSQL
{
    ...
    {
        public static RTrimFunction RTrim(this MSSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RTrimYFunction RTrim(this MSSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
