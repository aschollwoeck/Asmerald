...
namespace Asmerald.MSSQL
{
    ...
    {
        public static LTrimFunction LTrim(this MSSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static LTrimYFunction LTrim(this MSSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
