...
namespace Asmerald.MSSQL
{
    public static partial class AsmeraldSelectExtensions
    {
        ...
        public static SelectStatement Select(this MSSQLDSLContext stmt)
        {
            return new SelectStatement(stmt.QueryBuilder);
        }
        public static SelectColumnsStatement Select(this MSSQLDSLContext stmt, params ISelectExpression[] columns)
        {
            return new SelectColumnsStatement(stmt.QueryBuilder, columns);
        }
