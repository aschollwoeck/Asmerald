...
namespace Asmerald.Oracle
{
    public static partial class AsmeraldSelectExtensions
    {
        ...
        public static SelectStatement Select(this OracleDSLContext stmt)
        {
            return new SelectStatement(stmt.QueryBuilder);
        }
        public static SelectColumnsStatement Select(this OracleDSLContext stmt, params ISelectExpression[] columns)
        {
            return new SelectColumnsStatement(stmt.QueryBuilder, columns);
        }
