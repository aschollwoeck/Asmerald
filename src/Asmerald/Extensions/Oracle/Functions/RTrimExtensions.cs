...
namespace Asmerald.Oracle
{
    ...
    {
        public static RTrimFunction RTrim(this OracleDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RTrimYFunction RTrim(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
