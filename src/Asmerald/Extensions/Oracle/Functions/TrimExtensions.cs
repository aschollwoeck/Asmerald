...
namespace Asmerald.Oracle
{
    ...
    {
        public static TrimFunction Trim(this OracleDSLContext stmt, ISelectExpression x)
        {
        ...
        public static TrimYFunction Trim(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
