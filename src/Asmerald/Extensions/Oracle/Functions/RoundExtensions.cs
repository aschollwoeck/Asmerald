...
namespace Asmerald.Oracle
{
    ...
    {
        public static RoundFunction Round(this OracleDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RoundDigitsFunction Round(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
