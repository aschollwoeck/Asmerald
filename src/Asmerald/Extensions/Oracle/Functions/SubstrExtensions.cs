...
namespace Asmerald.Oracle
{
    ...
    {
        public static SubstrLengthFunction Substr(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstrFunction Substr(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
