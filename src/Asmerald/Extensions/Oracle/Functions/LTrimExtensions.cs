...
namespace Asmerald.Oracle
{
    ...
    {
        public static LTrimFunction LTrim(this OracleDSLContext stmt, ISelectExpression x)
        {
        ...
        public static LTrimYFunction LTrim(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
