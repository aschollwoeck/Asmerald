...
namespace Asmerald.Oracle
{
    ...
    {
        public static SubstringLengthFunction Substring(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstringFunction Substring(this OracleDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
