...
namespace Asmerald.MariaDB
{
    public static partial class AsmeraldSelectExtensions
    {
        ...
        public static SelectStatement Select(this MariaDBDSLContext stmt)
        {
            return new SelectStatement(stmt.QueryBuilder);
        }
        public static SelectColumnsStatement Select(this MariaDBDSLContext stmt, params ISelectExpression[] columns)
        {
            return new SelectColumnsStatement(stmt.QueryBuilder, columns);
        }
