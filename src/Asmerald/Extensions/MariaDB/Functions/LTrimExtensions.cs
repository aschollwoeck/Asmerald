...
namespace Asmerald.MariaDB
{
    ...
    {
        public static LTrimFunction LTrim(this MariaDBDSLContext stmt, ISelectExpression x)
        {
        ...
        public static LTrimYFunction LTrim(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
