...
namespace Asmerald.MariaDB
{
    ...
    {
        public static MinAggregateFunction Min(this MariaDBDSLContext stmt, params ISelectExpression[] x)
        {
            return new MinAggregateFunction(x);
        }
        public static MinFunction Min(this MariaDBDSLContext stmt, ISelectExpression x)
        {
