...
namespace Asmerald.MariaDB
{
    ...
    {
        public static RTrimFunction RTrim(this MariaDBDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RTrimYFunction RTrim(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
