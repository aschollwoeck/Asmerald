...
namespace Asmerald.MariaDB
{
    ...
    {
        public static TrimFunction Trim(this MariaDBDSLContext stmt, ISelectExpression x)
        {
        ...
        public static TrimYFunction Trim(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
