...
namespace Asmerald.MariaDB
{
    ...
    {
        public static SubstringLengthFunction Substring(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstringFunction Substring(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
