...
namespace Asmerald.MariaDB
{
    ...
    {
        public static MaxAggregateFunction Max(this MariaDBDSLContext stmt, params ISelectExpression[] x)
        {
            return new MaxAggregateFunction(x);
        }
        public static MaxFunction Max(this MariaDBDSLContext stmt, ISelectExpression x)
        {
