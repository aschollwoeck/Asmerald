...
namespace Asmerald.MariaDB
{
    ...
    {
        public static SubstrLengthFunction Substr(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstrFunction Substr(this MariaDBDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
