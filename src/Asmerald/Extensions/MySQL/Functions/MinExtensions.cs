...
namespace Asmerald.MySQL
{
    ...
    {
        public static MinAggregateFunction Min(this MySQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MinAggregateFunction(x);
        }
        public static MinFunction Min(this MySQLDSLContext stmt, ISelectExpression x)
        {
