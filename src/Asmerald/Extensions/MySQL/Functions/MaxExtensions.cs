...
namespace Asmerald.MySQL
{
    ...
    {
        public static MaxAggregateFunction Max(this MySQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MaxAggregateFunction(x);
        }
        public static MaxFunction Max(this MySQLDSLContext stmt, ISelectExpression x)
        {
