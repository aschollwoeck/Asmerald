...
namespace Asmerald.MySQL
{
    ...
    {
        public static RoundFunction Round(this MySQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RoundDigitsFunction Round(this MySQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
