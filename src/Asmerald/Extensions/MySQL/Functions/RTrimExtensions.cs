...
namespace Asmerald.MySQL
{
    ...
    {
        public static RTrimFunction RTrim(this MySQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RTrimYFunction RTrim(this MySQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
