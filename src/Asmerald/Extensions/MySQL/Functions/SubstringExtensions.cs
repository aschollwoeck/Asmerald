...
namespace Asmerald.MySQL
{
    ...
    {
        public static SubstringLengthFunction Substring(this MySQLDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstringFunction Substring(this MySQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
