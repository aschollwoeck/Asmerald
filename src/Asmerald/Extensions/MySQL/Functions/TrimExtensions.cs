...
namespace Asmerald.MySQL
{
    ...
    {
        public static TrimFunction Trim(this MySQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static TrimYFunction Trim(this MySQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
