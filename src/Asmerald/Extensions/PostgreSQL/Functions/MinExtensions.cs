...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static MinAggregateFunction Min(this PostgreSQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MinAggregateFunction(x);
        }
        public static MinFunction Min(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
