...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static TrimFunction Trim(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static TrimYFunction Trim(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
