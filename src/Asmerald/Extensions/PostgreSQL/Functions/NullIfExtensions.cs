...
{
    public static partial class AsmeraldNullIfExtensions
    {
        public static NullIfFunction NullIf(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
