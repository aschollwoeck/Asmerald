...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static RoundFunction Round(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RoundDigitsFunction Round(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
