...
{
    public static partial class AsmeraldCharExtensions
    {
        public static CharFuncFunction Char(this PostgreSQLDSLContext stmt, ISelectExpression x1, ISelectExpression x2, params ISelectExpression[] xn)
        {
