...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static MaxAggregateFunction Max(this PostgreSQLDSLContext stmt, params ISelectExpression[] x)
        {
            return new MaxAggregateFunction(x);
        }
        public static MaxFunction Max(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
