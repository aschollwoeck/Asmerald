...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static LTrimFunction LTrim(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static LTrimYFunction LTrim(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
