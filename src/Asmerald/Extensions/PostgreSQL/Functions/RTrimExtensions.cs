...
{
    public static partial class AsmeraldRTrimExtensions
    {
        public static RTrimFunction RTrim(this PostgreSQLDSLContext stmt, ISelectExpression x)
        {
        ...
        public static RTrimYFunction RTrim(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
