...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static SubstrLengthFunction Substr(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstrFunction Substr(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
