...
namespace Asmerald.PostgreSQL
{
    ...
    {
        public static SubstringLengthFunction Substring(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y, ISelectExpression z)
        {
        ...
        public static SubstringFunction Substring(this PostgreSQLDSLContext stmt, ISelectExpression x, ISelectExpression y)
        {
