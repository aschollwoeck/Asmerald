...
namespace Asmerald.PostgreSQL
{
    public static partial class AsmeraldSelectExtensions
    {
        ...
        public static SelectStatement Select(this PostgreSQLDSLContext stmt)
        {
            return new SelectStatement(stmt.QueryBuilder);
        }
        public static SelectColumnsStatement Select(this PostgreSQLDSLContext stmt, params ISelectExpression[] columns)
        {
            return new SelectColumnsStatement(stmt.QueryBuilder, columns);
        }
