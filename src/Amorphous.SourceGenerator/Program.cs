...
using Amorphous;
using Amorphous.SourceGenerator;
using Amorphous.SourceGenerator.Generators;
...
foreach (var provider in providers)
{
    ...
    foreach (var item in iniData.Sections["FUNCTIONS"])
    {
        ...
        var generatedCode = new Amorphous.SourceGenerator.Generators.FunctionGenerator().Generate(code);
    ...
    {
        var generatedCode = new Amorphous.SourceGenerator.Generators.FunctionExtensionGenerator().Generate(genCode);
    ...
    foreach (var item in iniData.Sections["CLASSES"])
    {
        ...
        var generatedCode = new Amorphous.SourceGenerator.Generators.StatementGenerator().Generate(code);
    ...
    {
        var generatedCode = new Amorphous.SourceGenerator.Generators.StatementExtensionGenerator().Generate(genCode);
