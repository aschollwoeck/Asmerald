...
namespace master
{
    ...
    {
        public static StProc_sp_MScleanupmergepublisher sp_MScleanupmergepublisher() => new StProc_sp_MScleanupmergepublisher();
        public class StProc_sp_MScleanupmergepublisher : Asmerald.StoredProcedures.IStoredProcedure
        {
            public string Name() => "dbo.sp_MScleanupmergepublisher";
            
            
            public StProc_sp_MScleanupmergepublisher()
            {
            }
