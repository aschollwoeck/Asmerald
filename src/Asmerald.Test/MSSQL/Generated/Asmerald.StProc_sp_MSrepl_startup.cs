...
namespace master
{
    ...
    {
        public static StProc_sp_MSrepl_startup sp_MSrepl_startup() => new StProc_sp_MSrepl_startup();
        public class StProc_sp_MSrepl_startup : Asmerald.StoredProcedures.IStoredProcedure
        {
            public string Name() => "dbo.sp_MSrepl_startup";
            
            
            public StProc_sp_MSrepl_startup()
            {
            }
