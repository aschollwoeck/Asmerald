...
var providers = new string[] { "SQLite", "PostgreSQL", "MySQL", "MariaDB", "MSSQL", "Oracle" };
...
foreach (var provider in providers)
{
    ...
    foreach (var item in iniData.Sections["FUNCTIONS"])
    {
        ...
        var generatedCode = new Asmerald.SourceGenerator.Generators.FunctionGenerator().Generate(code);
    ...
    {
        var generatedCode = new Asmerald.SourceGenerator.Generators.FunctionExtensionGenerator().Generate(genCode);
    ...
    foreach (var item in iniData.Sections["CLASSES"])
    {
        ...
        var generatedCode = new Asmerald.SourceGenerator.Generators.StatementGenerator().Generate(code);
    ...
    {
        var generatedCode = new Asmerald.SourceGenerator.Generators.StatementExtensionGenerator().Generate(genCode);
